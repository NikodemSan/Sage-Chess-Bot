...
Time is checked against a wall-clock deadline every 64 nodes through numba's objmode.
"""
...
TT_BITS = min(25, max(16, int(os.environ.get("SAGE_TT_BITS", "25"))))
TT_SIZE = 1 << TT_BITS
TT_MASK = TT_SIZE - 1
